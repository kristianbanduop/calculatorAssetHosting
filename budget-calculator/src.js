parcelRequire = function (e, r, t, n) {
    ...
    "boCh": [function (require, module, exports) {
        module.exports = {
            labels: {
                incomeIntroduction: ["While you’re at uni, you’ll have bills and fees to pay – so it’s important to know how much you’re spending each month, and whether you have enough money to cover everything.", "Your monthly budget is the amount of money coming into your bank account each month.", "If some of your income is paid when you need it or annually – perhaps you’ve got some savings to dip into, or you receive an annual grant – divide the total figure by 12 to get a monthly figure.", "Enter as many details as you can below, and then we’ll move onto your outgoings."],
                sectionTotal: "Total",
                previousTab: "Previous",
                nextTab: "Next",
                expenditureIntroduction: ["Many of your monthly costs will be unavoidable – like rent, transport, food and bills – but with a little planning, you can make your money go further.", "Enter as many details below as you can, and try not to underestimate what you spend, especially on things like going out and clothes shopping – if you do, you might find your money disappears quicker than you’re expecting. "],
                balanceHeader: "Your totals",
                totalIn: "In",
                totalOut: "Out",
                totalBalance: "Total",
                positiveBalance: ["Great news – the money you receive each month more than covers what you need to spend.", "Remember to stay on top of your outgoings though, as you’ll probably run into unexpected expenses during uni (like a higher-than-usual phone bill or a bigger-than-anticipated night out)."],
                breakevenBalance: ["Good news – the money you receive each month just about covers your spending.", "It’s worth thinking about reducing your outgoings or increasing your income, so you have a little buffer between the two – which can come in handy for the sort of unexpected expenses you might encounter at uni (like a higher-than-usual phone bill or a bigger-than-anticipated night out)."],
                negativeBalance: '<p>It looks like you’re spending more than you can afford right now, but don’t panic. </p> <p>Whether you need to cut down on a few things or work out a better way to balance your budget, our finance team can help you out. </p> <p> Drop them a line at <a href="tel:+442392843014">+44 (0) 2392 843014</a> or <a href="mailto:studentfinance@port.ac.uk" >studentfinance@port.ac.uk</a >.</p>'
            },
            income: {
                total: 0,
                items: [{
                    ...
                    name: "parental_contributions",
                    label: "Financial contributions (e.g. allowance from a family member)"
                }, {
                    name: "scholarships_grants",
                    label: "Scholarships and grants"
                }, {
                    name: "work",
                    label: "Part-time or full-time work"
                }, {
                    name: "other",
                    label: "Other"
                }]
            ...
            expenditure: {
                ...
                items: [{
                    ...
                    label: "Accommodation",
                    options: [{
                        label: "Bateson Hall (standard room)",
                        value: 3960
                    }, {
                        label: "Bateson Hall (large room)",
                        value: 4440
                    }, {
                        label: "Trafalgar Hall (standard room)",
                        value: 5240
                    }, {
                        label: "Trafalgar Hall (studio room)",
                        value: 6120
                    }, {
                        label: "Harry Law Hall (standard room)",
                        value: 5480
                    }, {
                        label: "Harry Law Hall (studio room)",
                        value: 6400
                    }, {
                        label: "Rosalind Franklin Hall (standard room)",
                        value: 5640
                    }, {
                        label: "Rosalind Franklin Hall (studio room)",
                        value: 6120
                    }, {
                        label: "Margaret Rule Hall (standard room)",
                        value: 5880
                    }, {
                        label: "Margaret Rule Hall (studio room)",
                        value: 6360
                    }, {
                        label: "Greetham Street Hall (standard room)",
                        value: 6520
                    }, {
                        label: "Catherine House (standard room)",
                        value: 6160
                    }, {
                        label: "Chaucer House (standard room)",
                        value: 6280
                    }, {
                        label: "Rees Hall (standard room)",
                        value: 6920
                    }, {
                        label: "Burrell House (standard and larger rooms)",
                        value: 6040
                    }]
                }, {
                    name: "food",
    ...
    "TC2m": [function (require, module, exports) {
        ...
        exports.default = t.default.extend({
            mounted: function () {
                var e = this;
                fetch("https://www.port.ac.uk/-/media/files/calculators/budget/data", {
                    mode: "no-cors"
                }).then(function (e) {
                    return e.json()
                }).then(function (t) {
                    var n = t.labels,
                        r = t.income,
                        o = t.expenditure;
                    console.log(r, o), e.labels = n, e.income = r, e.expenditure = o
                }).catch(function (e) {
                    return console.debug("Error fetching data from the server: ", e)
                })
            },
            data: function () {
                return {
            ...
            computed: {
                balance: function () {
                    return this.income.total - this.expenditure.total
                }
            }
        });
        (function () {
                ...
                render: function () {
                    ...
                    return s("div", [s("main", {
                        ...
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: e.isCurrentTab("income"),
                            expression: "isCurrentTab('income')"
                        }],
                        attrs: {
                            "collection-name": "Your monthly budget",
                            labels: e.labels
                        },
                        model: {
                            value: e.income,
                    ...
                    }, e._l(e.labels.incomeIntroduction, function (a, t) {
                        return s("p", {
                            key: t
                        }, [e._v(" " + e._s(a) + " ")])
                    }), 0), e._v(" "), s("sum-values", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: e.isCurrentTab("expenditure"),
                            expression: "isCurrentTab('expenditure')"
                        }],
                        attrs: {
                            "collection-name": "Your monthly spending",
                            labels: e.labels
                        },
                        model: {
                            value: e.expenditure,
                    ...
                    }, e._l(e.labels.expenditureIntroduction, function (a, t) {
                        return s("p", {
                            key: t
                        }, [e._v(" " + e._s(a) + " ")])
                    }), 0), e._v(" "), s("section", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: e.isCurrentTab("budget"),
                            expression: "isCurrentTab('budget')"
                        }],
                        staticClass: "section"
                    }, [s("h2", {
                        staticClass: "title"
                    }, [e._v(e._s(e.labels.balanceHeader))]), e._v(" "), s("p", [e._v(e._s(e.labels.totalIn) + " " + e._s(e.formattedMoney(e.income.total)))]), e._v(" "), s("p", [e._v(" " + e._s(e.labels.totalOut) + " " + e._s(e.formattedMoney(e.expenditure.total)) + " ")]), e._v(" "), s("p", [e._v(e._s(e.labels.totalBalance) + " " + e._s(e.formattedMoney(e.balance)))]), e._v(" "), e.balance > 0 ? s("div", {
                        staticClass: "box has-background-success"
                    }, e._l(e.labels.positiveBalance, function (a, t) {
                        return s("p", {
                            key: t
                        }, [e._v(" " + e._s(a) + " ")])
                    }), 0) : 0 === e.balance ? s("div", {
                        staticClass: "box"
                    }, e._l(e.labels.breakevenBalance, function (a, t) {
                        return s("p", {
                            key: t
                        }, [e._v(" " + e._s(a) + " ")])
                    }), 0) : s("div", {
                        staticClass: "box has-background-warning",
                        domProps: {
                            innerHTML: e._s(e.labels.negativeBalance)
                        }
                    })])], 1), e._v(" "), s("pagination-navigation", {
                        attrs: {
                            labels: e.labels,
                            tabs: e.tabs
                        },
    ...
    "LiZH": [function (require, module, exports) {
        "use strict";
        var e = this && this.__importDefault || function (e) {
            return e && e.__esModule ? e : {
                default: e
            ...
            computed: {
                formattedTotalAmount: function () {
                    return new Intl.NumberFormat("en-GB", {
                        style: "currency",
                        currency: "GBP"
                    }).format(this.value.total)
                }
            },
            methods: {
                totalAmount: function () {
                    this.value.total = this.value.items.reduce(function (e, t) {
                        return e + (void 0 === t.value ? 0 : t.value)
                    }, 0)
                },
                formattedMoney: function (e) {
                    return new Intl.NumberFormat("en-GB", {
            ...
            "function" == typeof t && (t = t.options), Object.assign(t, {
                render: function () {
                    ...
                    return s("section", {
                        ...
                        staticClass: "title"
                    }, [t._v(" " + t._s(t.collectionName) + " ")]), t._v(" "), t._t("default"), t._v(" "), s("form", {
                        staticClass: "form"
                    }, t._l(t.value.items, function (e) {
                        return s("div", {
                            key: e.name,
                            staticClass: "field"
                        }, [e.options ? s("datalist", {
                            attrs: {
                                id: e.name
                            }
                            ...
                            return s("option", {
                                key: e.label,
                                domProps: {
                                    value: (e.value / 12).toFixed(2)
                                }
                            }, [t._v(" " + t._s(e.label) + " – " + t._s(t.formattedMoney(e.value)) + " per year ")])
                        }), 0) : t._e(), t._v(" "), s("label", {
                            staticClass: "label"
                        }, [t._v(" " + t._s(e.label) + " "), s("p", {
                            ...
                            on: {
                                input: [function (s) {
                                    s.target.composing || t.$set(e, "value", t._n(s.target.value))
                                }, t.totalAmount],
                                blur: function (e) {
                    ...
                    }, [t._v(" " + t._s(t.labels.sectionTotal) + " " + t._s(t.formattedTotalAmount) + " ")])])], 2)
                },
                staticRenderFns: [],
                _compiled: !0,
                _scopeId: "data-v-a8e074",
                functional: void 0
            });
        })();
    }, {
    ...
    "PTfg": [function (require, module, exports) {
        "use strict";
        ...
        exports.default = e.default.extend({
            ...
            computed: {
                ...
                previousTab: function () {
                    var t = this.tabIndex - 1;
                    return t >= 0 ? this.tabs[t] : null
                },
                nextTab: function () {
                    var t = this.tabIndex + 1;
                    return t < this.tabs.length ? this.tabs[t] : null
                }
            },
            methods: {
                ...
                isCurrentTabStringOutput: function (t, e, r) {
                    return void 0 === r && (r = ""), this.isCurrentTab(t) ? e : r
                },
                isActiveTab: function (t) {
                    return this.isCurrentTab(t) ? "is-active" : ""
                },
            ...
            "function" == typeof t && (t = t.options), Object.assign(t, {
                render: function () {
                    ...
                    return n("div", {
                        ...
                        staticClass: "pagination-previous Button Button--xs",
                        on: {
                            click: function (a) {
                                return t.activateTab(t.previousTab.name)
                            }
                        }
                    }, [t._v(t._s(t.labels.previousTab))]) : t._e(), t._v(" "), t.nextTab ? n("a", {
                        staticClass: "pagination-next Button Button--primary",
                        on: {
                            click: function (a) {
                                return t.activateTab(t.nextTab.name)
                            }
                        }
                    }, [t._v(t._s(t.labels.nextTab))]) : t._e()])])
                },
                staticRenderFns: [],
                _compiled: !0,
                _scopeId: "data-v-1656d9",
                functional: void 0
            });
        })();
    }, {
    ...
    "Focm": [function (require, module, exports) {
        "use strict";
        var e = a(require("vue")),
            u = a(require("./components/App.vue")),
            n = a(require("./components/SumValues.vue")),
            t = a(require("./components/PaginationNavigation.vue"));
        ...
        e.default.component("sum-values", n.default), e.default.component("pagination-navigation", t.default), new e.default({
            render: function (e) {
                return e(u.default)
            }
        }).$mount("#budgetCalculator");
    }, {
        "vue": "QPfz",
        "./components/App.vue": "TC2m",
        "./components/SumValues.vue": "LiZH",
        "./components/PaginationNavigation.vue": "PTfg"
    }]
}, {}, ["Focm"], null)
//# sourceMappingURL=src.a0d4331d.js.map